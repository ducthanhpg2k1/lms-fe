...
const FormStartTakingTest = ({ dataQuizz }: { dataQuizz: any }) => {
  ...
  return (
    <div className="w-full flex flex-col min-h-[566px]">
      <div className="w-6/12 pt-20 flex-1 mx-auto flex items-start text-start flex-col gap-4">
        {answerCorrectly === true && (
          <div className="p-4 w-full bg-transparent rounded-2xl border-1 border-green">
        ...
        {answerCorrectly === false && (
          <div className="p-4 w-full bg-transparent rounded-2xl border-1 border-red-500">
        ...
        <Text type="font-32-700" className="text-white">{`Question ${
          currentQuestion + 1
        }`}</Text>
