...
const FormQuizz = ({ dataQuizz, handleClickContinueQuizz, handleSkipQuizz, loading }: { handleClickContinueQuizz: (id: string) => void, loading: boolean, dataQuizz: any, handleSkipQuizz: any }) => {
  ...
  return (
    <div className='relative'>
      ...
      {startTakingTest ? (
        <FormStartTakingTest handleClickContinueQuizz={handleClickContinueQuizz} dataQuizz={dataQuizz} />
      ) : (
